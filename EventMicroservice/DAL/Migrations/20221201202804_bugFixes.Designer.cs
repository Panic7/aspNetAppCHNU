...
namespace EventMicroservice.Migrations
{
    ...
    [Migration("20221201202804_bugFixes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Gallery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Image", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EventCategory", b =>
                {
                    b.HasOne("EventMicroservice.DAL.Entities.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventMicroservice.DAL.Entities.Event", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventUser", b =>
                {
                    ...
                    b.HasOne("EventMicroservice.DAL.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.City", b =>
                {
                    b.HasOne("EventMicroservice.DAL.Entities.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Event", b =>
                {
                    b.HasOne("EventMicroservice.DAL.Entities.User", "Author")
                        .WithMany("CreatedEvents")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EventMicroservice.DAL.Entities.City", "City")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Gallery", b =>
                {
                    b.HasOne("EventMicroservice.DAL.Entities.Event", "Event")
                        .WithOne("Gallery")
                        .HasForeignKey("EventMicroservice.DAL.Entities.Gallery", "EventId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("EventMicroservice.DAL.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.Image", b =>
                {
                    b.HasOne("EventMicroservice.DAL.Entities.Gallery", "Gallery")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("EventMicroservice.DAL.Entities.User", b =>
                {
                    ...
                    b.HasOne("EventMicroservice.DAL.Entities.Role", "Role")
                        .WithMany("Users")
